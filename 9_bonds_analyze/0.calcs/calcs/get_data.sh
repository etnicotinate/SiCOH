...
for file in *
    do  
        ...
        then
            ...
            cp stress_strain/stress_strain.pos3.png ../pngs/stress_strain/$dir.stress_strain.png
            ...
            cp bonds.pos3.png ../../pngs/bonds/$dir.bonds.png
            cp bonds.pie_pos3.png ../../pngs/bonds/$dir.bonds.pie.png
            
            cp QTD.png ../../pngs/QTD/$dir.QTD.png
            cp QTD_pie.png ../../pngs/QTD/$dir.QTD_pie.png
            echo "Bonds and QTD PNGs for $dir has been extracted to calcs/pngs"
            cd ..  # back to dir
